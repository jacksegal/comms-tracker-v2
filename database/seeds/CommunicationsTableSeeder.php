...
DB::table('communications')->insert([
      'id' => '30',
      'title' => 'Bristol Local Group fundraiser',
      'description' => 'Fundraising night (Q&A and live music) for the Bristol Greenpeace group on the 27th April.',
      'basket_id' => '3',
      'area_id' => '8',
...
DB::table('communications')->insert([
      'id' => '31',
      'title' => 'Shoreditch Local Group event',
      'description' => 'Film & debate night on the 30th April.',
      'basket_id' => '3',
      'area_id' => '8',
...
DB::table('communications')->insert([
      'id' => '32',
      'title' => 'Climate Emergency kicker and spread',
      'description' => '',
      'basket_id' => '1',
      'area_id' => '1',
      'sub_area_id' => '21',
...
DB::table('communications')->insert([
      'id' => '33',
      'title' => 'PLN recruitment',
      'description' => 'PLN recruitment in Newark, Thurrock and other target constituencies linked to our Rivers work',
      'basket_id' => '5',
      'area_id' => '12',
      'sub_area_id' => '14',
      'campaign_push_id' => '22',
...
DB::table('communications')->insert([
      'id' => '35',
      'title' => 'Climate emergency - DD conversion',
      'description' => 'DD conversion email to climate emergency petition signers (possibly to include those who already gave a cash gift off the back of the petition - tbc). Considering sending two different versions as a 50-50 split test on content.',
      'basket_id' => '1',
      'area_id' => '1',
      'sub_area_id' => '21',
      'campaign_push_id' => '27',
...
DB::table('communications')->insert([
      'id' => '36',
      'title' => 'Climate emergency launch mop up',
      'description' => 'Mop up to new people who got stuck in the welcome process',
      'basket_id' => '1',
      'area_id' => '1',
      'sub_area_id' => '21',
      'campaign_push_id' => '27',
...
DB::table('communications')->insert([
      'id' => '37',
      'title' => 'Climate emergency - twitter ask',
      'description' => 'Debate in parliament - this would be to people in cons groups of MPs who didn\'t turn up to the debate. Also only climate emergency petition signers.',
      'basket_id' => '1',
      'area_id' => '1',
      'sub_area_id' => '21',
      'campaign_push_id' => '27',
...
DB::table('communications')->insert([
      'id' => '38',
      'title' => 'Unearthed biodiversity series round up',
      'description' => 'Round up of Unearthed biodiversity video series with link to ocean sanctuaries ahead of cash and upgrade asks.',
      'basket_id' => '3',
      'area_id' => '6',
...
DB::table('communications')->insert([
      'id' => '41',
      'title' => 'KR Connect and appeal reminder',
      'description' => '',
      'basket_id' => '3',
      'area_id' => '6',
...
DB::table('communications')->insert([
      'id' => '43',
      'title' => 'KR Exeter donor visit',
      'description' => 'Legacy pipeline people',
      'basket_id' => '3',
      'area_id' => '6',
...
DB::table('communications')->insert([
      'id' => '45',
      'title' => 'bcochran@greenpeace.org',
      'description' => 'NO MORE EMAILS THIS WEEK PLEASE',
      'basket_id' => '3',
      'area_id' => '7',
...
DB::table('communications')->insert([
      'id' => '46',
      'title' => 'Forests - XCOM - Survey',
      'description' => 'Survey to current supporters on cross commodities, forests and meat reduction',
      'basket_id' => '2',
      'area_id' => '18',
      'sub_area_id' => '22',
      'campaign_push_id' => '28',
